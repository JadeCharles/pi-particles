...
import NeuroMatrix from "../components/neuron-matrix.js";
...
class MatrixNeuroApp {
    ...
    constructor(...args) {
        ...
        this.squashFunction = new ActivationFunction(ActivationFunction.sigmoid, ActivationFunction.sigmoidPrime, "Sigmoid");
    ...
    static fromJson(json) {
        ...
        const squashFunction = ActivationFunction.fromName(json.squashFunction);
     ...
     * @returns {MatrixNeuroApp} - So we can chain methods together
     */
    setActivationFunction(squashFunction = null) {
    ...
    train(inputs, expectedOutputs) {
        ...
        // Calculate gradient
        let gradients = NeuroMatrix.setMatrixValues(outputs, this.squashFunction.getPartialDerivative);
        ...
        while (weightsIndex > 0) {
            ...
            gradients = NeuroMatrix.setMatrixValues(activations, this.squashFunction.getPartialDerivative);
