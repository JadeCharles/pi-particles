...
class FeedForwardNueralNetwork {
    ...
    initWithMatrixNetwork(matrixNeuroApp, options = null) {
        ...
        for (i = 0; i < matrixNeuroApp.neuronCounts.length - 1; i++) {
            ...
            const layerOptions = { name: name, neuronCount: neuronCount, biasCount: 1, vectorHandler: options?.vectorHandler, app: this.app };
            const hiddenLayer = new NeuronLayer(this, layerOptions)
