...
!function (e, t) {
  ...
  var I = {
    ...
    forEach: T,
    merge: function e() {
      for (var t = x(this) && this || {}, n = t.caseless, r = {}, o = function o(t, _o) {
          var i = n && j(r, _o) || _o;
    ...
    return r(i, [{
      ...
      value: function value(e, t, n) {
        ...
        return I.isPlainObject(e) || e instanceof this.constructor ? f(e, t) : I.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim()) ? f((c = {}, (i = e) && i.split("\n").forEach(function (e) {
          u = e.indexOf(":"), a = e.substring(0, u).trim().toLowerCase(), s = e.substring(u + 1).trim(), !a || c[a] && le[a] || ("set-cookie" === a ? c[a] ? c[a].push(s) : c[a] = [s] : c[a] = c[a] ? c[a] + ", " + s : s);
  ...
  var Te = function Te(e) {
    for (var t, n, r = (e = I.isArray(e) ? e : [e]).length, o = 0; o < r && (t = e[o], !(n = I.isString(t) ? Ae[t.toLowerCase()] : t)); o++);
    if (!n) {
  ...
  function Ne(e) {
    return je(e), e.headers = ve.from(e.headers), e.data = be.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), Te(e.adapter || fe.adapter)(e).then(function (t) {
  ...
  ke.transitional = function (e, t, n) {
    function r(e, t) {
      return "[Axios v1.3.3] Transitional option '" + e + "'" + t + (n ? ". " + n : "");
    }
  ...
  var Me = function e(t) {
    ...
    return I.extend(r, Be.prototype, n, {
      allOwnKeys: !0
    }), I.extend(r, n, null, {
      allOwnKeys: !0
    }), r.create = function (n) {
  ...
  return Me.Axios = Be, Me.CanceledError = we, Me.CancelToken = De, Me.isCancel = ge, Me.VERSION = Pe, Me.toFormData = V, Me.AxiosError = q, Me.Cancel = Me.CanceledError, Me.all = function (e) {
